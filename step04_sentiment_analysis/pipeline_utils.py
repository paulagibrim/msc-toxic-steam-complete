"""Minimal logging/IO helpers - same as step02_run_detoxify's, copied here
so this folder stays independently copyable to whatever machine runs the
sentiment model (a GPU machine, same one step02/step03 used)."""
import os
